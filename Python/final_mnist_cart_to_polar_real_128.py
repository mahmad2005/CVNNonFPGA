# -*- coding: utf-8 -*-
"""Final_MNIST_Cart_to_Polar_Real_128.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xz_HDK2oUDaEc_iVUOpZGJQgBEphWcgI
"""
...
def mlp_function(train_images, train_labels, val_images, val_labels, epochs=10):
  ...
  model_ANN.add(tf.keras.Input(shape=(256,)))
...
model_ANN.save_weights('model_weights_128ANN.h5')
#%cp /content/model_weights_128ANN.h5 /content/drive/MyDrive/MSresearch/model_weights_128ANN.h5

"""#Testing"""

#%cp /content/drive/MyDrive/MSresearch/model_weights_128ANN.h5 /content/model_weights_128ANN.h5

acti = 'relu'

model_2 = models.Sequential()
model_2.add(tf.keras.Input(shape=(256,)))                    # Always use ComplexInput at the start
model_2.add(tf.keras.layers.Dense(20, activation='relu'))
model_2.add(tf.keras.layers.Dense(10, activation='softmax'))

model_2.load_weights('model_weights_128ANN.h5')
model_2.summary()
...
disp.plot(cmap=cmap)
plt.savefig("ConfusionMatrix_Polar_128_Real_ANN_20N.png", dpi=600)
...
model_2 = models.Sequential()
model_2.add(tf.keras.Input(shape=(256,)))
model_2.add(tf.keras.layers.Dense(20, activation='relu'))
model_2.add(tf.keras.layers.Dense(10, activation='softmax'))
